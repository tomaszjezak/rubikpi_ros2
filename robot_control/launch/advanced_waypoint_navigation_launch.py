...
def generate_launch_description():
    ...
    # Advanced waypoint navigation node with trajectory generation
    advanced_waypoint_node = Node(
        package='robot_control',
        executable='advanced_waypoint_navigation',
        name='advanced_waypoint_navigation_node',
        output='screen',
        emulate_tty=True,
        parameters=[],
    )
